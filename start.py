...
class Start_window:
    ...
    def create_main_window(self):
        ...
        self.app.c_main.create_text(400, 185, text="Goals for today", font=("Arial", 30), fill=self.settings.font_color)
        self.app.c_main.create_line(250, 210, 550, 210, fill=self.settings.second_color, width=5)
    ...
    def _b_start_make(self):
        ...
        self.b_start = CTkButton(self.app, text=texts[option], fg_color=self.settings.main_color, font=("Arial", 50),
                                 ...
                                 text_color=self.settings.font_color, command=self.app.setup1.create_setup1_window,
